...
vim_plugin_task "vim-fuzzyfinder",  "git://github.com/clones/vim-fuzzyfinder.git"
vim_plugin_task "vimgit",           "git://github.com/Chib/vimgit.git"
vim_plugin_task "vim-rubytest",     "git://github.com/janx/vim-rubytest.git"
